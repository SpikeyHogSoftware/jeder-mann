<template>
  <FeatureCard i18nKey="benefits" class="pb-4">
          ...
          >
            ...
            >
              ...
              <template #front>
                ...
                ></v-img>
                <component
                  v-if="item.customComponentIcon"
                  :is="item.customComponentIcon"
                ></component>
                -->
              </template>
              <template #back>
